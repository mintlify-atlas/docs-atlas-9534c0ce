...
description: "How PunctuOwlity stays focused as a personal event tracker, and why the browser demo replicates the Android app using localStorage instead of SQLite."
---
